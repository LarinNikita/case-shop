...
export default function Page() {
    ...
    return (
        <div
            className={cn(
                'relative my-16 flex size-full flex-1 cursor-pointer flex-col items-center justify-center rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl',
                {
